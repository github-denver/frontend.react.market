...
const BoardWrite = ({ children, attributes }) => {
  const { category, number, user, formData, recipesFormData, field, upload, read, error, loading, owner, fakeFields, onChangeSubject, onChangeThumbnail, onClickFakeField, onChangeSelect, onChangeChoice, hour, minute, second, quill, recipeModifyFormFields, handleAddFields } = attributes || {};
        ...
        return (
          <div className="write_recipe" key={index}>
            ...
            <div className="inner_recipe">
              ...
              <ViewFinder
                attributes={{
                  type: 'recipeModifyFormFields',
                  src: recipeModifyFormFields[index].thumbnail?.preview,
                  url: read.recipes[index]?.thumbnail,
                  event: onChangeThumbnail,
                  isTags: true,
                  idx: index
                }}
              ...
              <TextArea index={index} value={recipeModifyFormFields[index].content} event={handleInputChange} />
