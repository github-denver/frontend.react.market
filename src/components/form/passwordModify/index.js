...
const StyledPasswordModify = styled.div`
  max-width: 31.2rem;
  margin: -1.2rem auto 0;
  text-align: center;
`;

const PasswordModify = ({ formData, errorMessage, onPasswordModify, onChangeField, onCloseLayer, visibleLayer }) => {
  return (
    <StyledPasswordModify>
